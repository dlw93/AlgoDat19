...
\usepackage{amssymb, mathtools, cancel, pgfplots, nicefrac}
...
\date{}
\titlegraphic{\includegraphics[width=75pt, height=75pt]{images/husiegel_bw.eps}}
...
\newcommand<>{\teal}[1]{\textit#2{\color#2{teal}#1}}
\newcommand<>{\red}[1]{\textit#2{\color#2{madderlake}#1}}
\newcommand<>{\orange}[1]{\textit#2{\color#2{mandarin}#1}}
...
\begin{beamercolorbox}[wd=\paperwidth,ht=0.618\paperheight]{title page header}
    ...
    \vspace*{-5pt}
    \vfill
    \tikz[remember picture, overlay] \node[anchor=center] at (0.785\paperwidth,0) {\inserttitlegraphic};
\end{beamercolorbox}
\vspace*{2pt}
